...
class Animation:
    ...
    def SlowLine(text,t=0.5):
        for i in text.split('\n'):
            time.sleep(t)
            print(i)

    # python for ever...-
    def Text(CLT=G,CUT=W,t=0.2,text='C#tB#eG#xP#t',AT='Animation',repeat=2):
        AT=' '+AT+' '
    ...
    def DL(AT=['B#│','G#█','C#▒','B#│'],text='Loading',t=0.2,width=25):
        text = Color.reader(str(text))
